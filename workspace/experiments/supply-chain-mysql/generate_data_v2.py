...
def rd(a=-365, b=0):
    d = datetime.now() + timedelta(days=random.randint(a, b))
    return f"'{d.strftime('%Y-%m-%d')}'"
def rdt(days=365):
    dt = datetime.now() - timedelta(seconds=random.randint(0, days * 86400))
    return "'" + dt.strftime("%Y-%m-%d %H:%M:%S") + "'"
def rp():
    p = ["138", "139", "136", "137", "135", "150", "151", "152", "158", "159", "186", "187", "188"]
    return random.choice(p) + "".join(random.choices("0123456789", k=8))
def esc(s):
    if s is None or s == "NULL": return "NULL"
...
oid = idg(1)
org_data = [
    ("GROUP001", "环球供应链集团", 1, 0, 1, "/1/", None, "010-88888888", "group@scm.com", "北京市朝阳区环球中心", 0, 1, "集团总部"),
    ("COMP001", "华东分公司", 2, 1, 2, "/1/2/", 3, "021-66668888", "huadong@scm.com", "上海市浦东新区张江高科", 1, 1, "华东区域"),
    ("COMP002", "华南分公司", 2, 1, 2, "/1/3/", 4, "020-88886666", "huanan@scm.com", "广州市天河区珠江新城", 2, 1, "华南区域"),
    ("COMP003", "华北分公司", 2, 1, 2, "/1/4/", 5, "010-66669999", "huabei@scm.com", "北京市海淀区中关村", 3, 1, "华北区域"),
    ("DEPT001", "采购部", 3, 2, 3, "/1/2/5/", 6, "021-66668801", "purchase@scm.com", "上海市浦东新区张江高科A座", 1, 1, "负责采购业务"),
    ("DEPT002", "销售部", 3, 2, 3, "/1/2/6/", 7, "021-66668802", "sales@scm.com", "上海市浦东新区张江高科A座", 2, 1, "负责销售业务"),
    ("DEPT003", "仓储部", 3, 2, 3, "/1/2/7/", 8, "021-66668803", "warehouse@scm.com", "上海市浦东新区张江高科B座", 3, 1, "负责仓储管理"),
    ("DEPT004", "物流部", 3, 2, 3, "/1/2/8/", 9, "021-66668804", "logistics@scm.com", "上海市浦东新区张江高科B座", 4, 1, "负责物流配送"),
    ("DEPT005", "财务部", 3, 2, 3, "/1/2/9/", 10, "021-66668805", "finance@scm.com", "上海市浦东新区张江高科A座", 5, 1, "负责财务管理"),
    ("WH001", "上海中心仓", 4, 3, 3, "/1/2/10/", 8, "021-66668810", "sh-warehouse@scm.com", "上海市浦东新区物流园1号", 10, 1, "华东主仓库"),
]
R["organization"] = [(next(oid), *x[:-1], now(), now(), 0, 0, "NULL", 1, x[-1]) for x in org_data]
...
spus_data = [
    ("SPU0001", "华为Mate60 Pro智能手机", 2, 1, "件", 0.225, 0.0005, "6901443256789", '["颜色","存储容量"]', "华为旗舰智能手机搭载麒麟9000S芯片支持卫星通话", "https://img.scm.com/spu/mate60pro.jpg", '["https://img.scm.com/spu/mate60pro-1.jpg","https://img.scm.com/spu/mate60pro-2.jpg"]', 1),
    ("SPU0002", "iPhone 15 Pro Max", 2, 2, "件", 0.221, 0.0004, "1901987654321", '["颜色","存储容量"]', "苹果顶级旗舰手机钛金属边框A17 Pro芯片", "https://img.scm.com/spu/iphone15pm.jpg", '["https://img.scm.com/spu/iphone15pm-1.jpg"]', 1),
    ("SPU0003", "小米14", 2, 3, "件", 0.193, 0.0004, "6912345678901", '["颜色","存储容量"]', "徕卡光学镜头骁龙8 Gen3处理器", "https://img.scm.com/spu/mi14.jpg", '["https://img.scm.com/spu/mi14-1.jpg"]', 1),
    ("SPU0004", "联想拯救者Y9000P", 3, 4, "件", 2.550, 0.0120, "6945678901234", '["配置"]', "高性能游戏本第14代英特尔酷睿i9", "https://img.scm.com/spu/y9000p.jpg", '["https://img.scm.com/spu/y9000p-1.jpg"]', 1),
    ("SPU0005", "华为FreeBuds Pro 3", 4, 1, "件", 0.058, 0.0001, "6901443256790", '["颜色"]', "旗舰真无线耳机支持空间音频", "https://img.scm.com/spu/fbpro3.jpg", '["https://img.scm.com/spu/fbpro3-1.jpg"]', 1),
    ("SPU0006", "每日坚果礼盒", 6, 5, "件", 0.500, 0.0020, "6956789012345", '["规格"]', "精选全球优质坚果科学配比", "https://img.scm.com/spu/jianguo.jpg", '["https://img.scm.com/spu/jianguo-1.jpg"]', 1),
    ("SPU0007", "可口可乐330ml*24罐", 7, 6, "箱", 8.500, 0.0250, "6951234567890", '["口味"]', "经典碳酸饮料整箱装", "https://img.scm.com/spu/coke.jpg", '["https://img.scm.com/spu/coke-1.jpg"]', 1),
    ("SPU0008", "海飞丝去屑洗发水", 10, 7, "件", 0.450, 0.0008, "6952345678901", '["容量"]', "持久去屑止痒清爽控油", "https://img.scm.com/spu/hfs.jpg", '["https://img.scm.com/spu/hfs-1.jpg"]', 1),
    ("SPU0009", "汰渍洗衣液3kg", 11, 7, "件", 3.200, 0.0040, "6953456789012", '["香型"]', "深层洁净护色亮彩", "https://img.scm.com/spu/tz.jpg", '["https://img.scm.com/spu/tz-1.jpg"]', 1),
    ("SPU0010", "耐克Air Max运动鞋", 15, 8, "件", 0.850, 0.0035, "6954567890123", '["颜色","尺码"]', "经典气垫缓震舒适透气", "https://img.scm.com/spu/airmax.jpg", '["https://img.scm.com/spu/airmax-1.jpg"]', 1),
    ("SPU0011", "优衣库HEATTECH保暖内衣", 14, 9, "件", 0.180, 0.0003, "6955678901234", '["颜色","尺码"]', "吸湿发热科技轻盈保暖", "https://img.scm.com/spu/heattech.jpg", '["https://img.scm.com/spu/heattech-1.jpg"]', 1),
    ("SPU0012", "伊利纯牛奶250ml*24盒", 7, 10, "箱", 6.500, 0.0200, "6956789012345", '["规格"]', "优质乳蛋白营养早餐奶", "https://img.scm.com/spu/milk.jpg", '["https://img.scm.com/spu/milk-1.jpg"]', 1),
    ("SPU0013", "华为MatePad Pro平板", 3, 1, "件", 0.460, 0.0010, "6901443256791", '["颜色","存储容量"]', "专业生产力平板鸿蒙系统", "https://img.scm.com/spu/matepad.jpg", '["https://img.scm.com/spu/matepad-1.jpg"]', 1),
    ("SPU0014", "苹果MacBook Pro 16", 3, 2, "件", 2.150, 0.0100, "1901987654322", '["配置"]', "M3 Max芯片专业级性能", "https://img.scm.com/spu/mbp16.jpg", '["https://img.scm.com/spu/mbp16-1.jpg"]', 1),
    ("SPU0015", "男士商务休闲衬衫", 13, 9, "件", 0.250, 0.0005, "6957890123456", '["颜色","尺码"]', "免烫易打理商务通勤", "https://img.scm.com/spu/shirt.jpg", '["https://img.scm.com/spu/shirt-1.jpg"]', 1),
    ("SPU0016", "奥利奥夹心饼干", 6, 5, "件", 0.150, 0.0003, "6958901234567", '["口味"]', "经典黑白配浓郁可可香", "https://img.scm.com/spu/oreo.jpg", '["https://img.scm.com/spu/oreo-1.jpg"]', 1),
    ("SPU0017", "农夫山泉天然水550ml*24瓶", 7, 10, "箱", 12.500, 0.0300, "6959012345678", '["规格"]', "源自天然水源地弱碱性水", "https://img.scm.com/spu/nfsq.jpg", '["https://img.scm.com/spu/nfsq-1.jpg"]', 1),
    ("SPU0018", "舒肤佳沐浴露", 10, 7, "件", 0.520, 0.0010, "6960123456789", '["香型","容量"]', "温和亲肤抑菌保护", "https://img.scm.com/spu/sfj.jpg", '["https://img.scm.com/spu/sfj-1.jpg"]', 1),
    ("SPU0019", "金龙鱼食用油5L", 8, 5, "件", 4.800, 0.0060, "6961234567890", '["种类"]', "非转基因物理压榨", "https://img.scm.com/spu/jly.jpg", '["https://img.scm.com/spu/jly-1.jpg"]', 1),
    ("SPU0020", "李宁运动跑步鞋", 15, 8, "件", 0.720, 0.0030, "6962345678901", '["颜色","尺码"]', "轻量化设计缓震回弹", "https://img.scm.com/spu/lining.jpg", '["https://img.scm.com/spu/lining-1.jpg"]', 1),
]
spuid = idg(1)
spus = []
for s in spus_data:
    spus.append((next(spuid), *s, now(), now(), 0, 0, "NULL", 1, None))
R["product_spu"] = spus
...
base_prices = {1:6999,2:9999,3:3999,4:14999,5:1299,6:89,7:58,8:45,9:35,10:899,11:99,12:72,13:4999,14:19999,15:199,16:8,17:36,18:28,19:68,20:399}
...
for spu in spus:
    ...
    bp=base_prices[spu_id]
    if not s:
        sid=next(skuid)
        sku_code=f"SKU{spu_id:04d}01"
        sku_name=f"{spu_name} 标准版"
        skus.append((sid,sku_code,spu_id,sku_name,"{}",None,None,None,bp*0.7,bp,bp*1.2,1,now(),now(),0,0,"NULL",1,None))
        prices.append((next(pid),sid,3,bp,1,None,rd(-180,0),rd(180,365),1,now(),now(),0,0,"NULL",1,None))
    else:
        keys=list(s.keys())
        if len(keys)==1:
            vals=s[keys[0]]
            for i,v in enumerate(vals):
                ...
                spec_json='{"'+keys[0]+'":"'+v+'"}'
                bpp=bp+random.randint(-50,200) if spu_id<=5 else bp+random.randint(-5,20)
                skus.append((sid,sku_code,spu_id,sku_name,spec_json,None,None,None,bpp*0.6,bpp,bpp*1.15,1,now(),now(),0,0,"NULL",1,None))
                prices.append((next(pid),sid,1,bpp*0.6,1,None,rd(-180,0),rd(180,365),1,now(),now(),0,0,"NULL",1,None))
                prices.append((next(pid),sid,3,bpp,1,None,rd(-180,0),rd(180,365),1,now(),now(),0,0,"NULL",1,None))
                barcodes.append((next(bid),sid,f"690{random.randint(100000000,999999999)}",1,1.0,1,1,now(),now(),0,0,"NULL",1,None))
        else:
            vals1=s[keys[0]]
            vals2=s[keys[1]]
            idx=1
            for v1 in vals1:
                for v2 in vals2:
                    ...
                    bpp=bp+random.randint(-100,300) if spu_id<=5 else bp+random.randint(-10,30)
                    skus.append((sid,sku_code,spu_id,sku_name,spec_json,None,None,None,bpp*0.6,bpp,bpp*1.15,1,now(),now(),0,0,"NULL",1,None))
                    prices.append((next(pid),sid,1,bpp*0.6,1,None,rd(-180,0),rd(180,365),1,now(),now(),0,0,"NULL",1,None))
                    prices.append((next(pid),sid,3,bpp,1,None,rd(-180,0),rd(180,365),1,now(),now(),0,0,"NULL",1,None))
                    barcodes.append((next(bid),sid,f"690{random.randint(100000000,999999999)}",1,1.0,1,1,now(),now(),0,0,"NULL",1,None))
...
print(f"Products: {len(spus)} SPUs, {len(skus)} SKUs, {len(prices)} prices, {len(barcodes)} barcodes")
...
scid=idg(1)
R["supplier_contact"]=[
    (next(scid),1,"张经理","采购总监",rp(),"zhang@huawei.com","zhang_mgr",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),1,"李助理","采购助理",rp(),"li@huawei.com","li_assist",0,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),2,"王总监","供应链总监",rp(),"wang@foxconn.com","wang_dir",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),3,"赵采购","大客户经理",rp(),"zhao@jd.com","zhao_sales",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),4,"孙经理","销售经理",rp(),"sun@yili.com","sun_sales",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),5,"周总监","渠道总监",rp(),"zhou@pg.com","zhou_ch",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),6,"吴经理","批发经理",rp(),"wu@nike.com","wu_wholesale",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),7,"郑采购","采购主管",rp(),"zheng@uniqlo.com","zheng_buyer",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),8,"钱经理","销售总监",rp(),"qian@cofco.com","qian_sales",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),9,"冯总监","商务总监",rp(),"feng@sf-express.com","feng_bd",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),10,"陈经理","客户经理",rp(),"chen@coca-cola.com","chen_sales",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),11,"褚采购","渠道经理",rp(),"chu@lenovo.com","chu_ch",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),12,"卫经理","销售代表",rp(),"wei@xiaomi.com","wei_rep",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),13,"蒋总监","电商总监",rp(),"jiang@3songshu.com","jiang_ec",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),14,"沈经理","KA经理",rp(),"shen@nongfu.com","shen_ka",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),15,"韩采购","采购经理",rp(),"han@jinlongyu.com","han_buyer",1,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),4,"杨助理","销售助理",rp(),"yang@yili.com","yang_assist",0,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),6,"朱主管","区域主管",rp(),"zhu@nike.com","zhu_reg",0,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),9,"秦客服","客服专员",rp(),"qin@sf-express.com","qin_cs",0,1,now(),now(),0,0,"NULL",1,None),
    (next(scid),12,"尤经理","大客户经理",rp(),"you@xiaomi.com","you_ka",0,1,now(),now(),0,0,"NULL",1,None),
]
...
for sid in range(1,16):
    for p in periods:
        q=random.randint(75,99); d=random.randint(70,98); s=random.randint(72,97); pr=random.randint(68,95)
        t=(q+d+s+pr)/4
...
scnid=idg(1)
R["supplier_contract"]=[
    (next(scnid),"CT2024001",1,1,"华为年度采购框架协议","2024-01-01","2024-12-31",50000000.00,"月结30天","JIT交付","违约金为合同金额10%",None,"2024-01-05","张三",1,1,now(),now(),0,0,"NULL",1,"年度框架协议"),
    (next(scnid),"CT2024002",2,2,"富士康代工服务协议","2024-01-01","2024-12-31",80000000.00,"预付30%月结70%","按订单生产","延迟交付按日0.5%扣款",None,"2024-01-10","张三",1,1,now(),now(),0,0,"NULL",1,"代工协议"),
    (next(scnid),"CT2024003",4,1,"伊利乳制品采购合同","2024-02-01","2024-12-31",20000000.00,"货到付款","每周配送2次","质量问题无条件退换",None,"2024-02-05","赵六",1,1,now(),now(),0,0,"NULL",1,"乳制品采购"),
    (next(scnid),"CT2024004",5,1,"宝洁日化产品采购协议","2024-03-01","2025-02-28",15000000.00,"月结45天","每月15日配送","首批支持退换",None,"2024-03-01","赵六",1,1,now(),now(),0,0,"NULL",1,"日化采购"),
    (next(scnid),"CT2024005",6,2,"耐克运动鞋服经销合同","2024-01-01","2024-12-31",30000000.00,"预付20%季结80%","季度补货","季末可退换20%",None,"2024-01-15","李四",1,1,now(),now(),0,0,"NULL",1,"经销合同"),
    (next(scnid),"CT2024006",9,3,"顺丰物流运输服务协议","2024-01-01","2024-12-31",10000000.00,"月结30天","次日达","货损全额赔付",None,"2024-01-08","王五",1,1,now(),now(),0,0,"NULL",1,"物流协议"),
    (next(scnid),"CT2024007",10,1,"可口可乐饮料采购合同","2024-04-01","2025-03-31",12000000.00,"月结30天","每周配送","夏季旺季优先供应",None,"2024-04-01","赵六",1,1,now(),now(),0,0,"NULL",1,"饮料采购"),
    (next(scnid),"CT2024008",14,1,"农夫山泉饮用水采购协议","2024-05-01","2025-04-30",8000000.00,"货到付款","每周配送3次","支持季节性调价",None,"2024-05-05","赵六",1,1,now(),now(),0,0,"NULL",1,"饮用水采购"),
    (next(scnid),"CT2024009",11,1,"联想电脑设备采购合同","2024-06-01","2025-05-31",25000000.00,"预付30%到货70%","按订单交付","质保三年上门",None,"2024-06-01","张三",1,1,now(),now(),0,0,"NULL",1,"IT设备采购"),
    (next(scnid),"CT2024010",3,2,"京东渠道供货协议","2024-07-01","2025-06-30",18000000.00,"实销实结","JIT补货","滞销可退",None,"2024-07-01","李四",1,1,now(),now(),0,0,"NULL",1,"渠道协议"),
]

# Supplier products - use actual SKU IDs
sppid=idg(1)
supplier_products=[]
# Map suppliers to some actual SKUs
sku_ids_by_spu = {}
for sku in skus:
    sku_ids_by_spu.setdefault(sku[2], []).append(sku[0])
...
for sid, spu_list in supplier_spu_map.items():
    for spu_id in spu_list:
        if spu_id not in sku_ids_by_spu: continue
        for sku_id in sku_ids_by_spu[spu_id]:
            sku = next(s for s in skus if s[0]==sku_id)
            cp = sku[8]
            pp = cp*(1+random.uniform(0.05,0.25))
            supplier_products.append((next(sppid), sid, sku_id, sku[1], sku[3], round(pp,4), 13.0, 1.0, random.randint(3,14), 1 if sid in [1,2] else 0, rd(-180,0), rd(180,365), 1, now(), now(), 0, 0, "NULL", 1, None))
...
R["customer_level"]=[
    ...
    (4,"LV04","钻石会员",200000.00,"NULL",85.00,200000.00,120,1,now(),now(),0,0,"NULL",1,None),
]
...
print("Warehouses and customers done")
...
for i in range(1,16):
    ...
    apr=2 if stat>=2 else random.choice([0,1,2,3])
    rid=next(prid)
    purchase_requests.append((rid,req_no,org,reqr,rdd,exp,total,qty,"CNY",random.choice([1,2,3]),apr,stat,now(),now(),0,0,"NULL",1,f"常规采购申请{i}"))
    for _ in range(random.randint(2,4)):
        sku=random.choice(skus)
        q=random.randint(10,200)
        up=sku[9]
        amt=q*up
        purchase_request_items.append((next(priid),rid,sku[0],q,up,amt,None,1,now(),now(),0,0,"NULL",1,None))
...
for i in range(1,16):
    ...
    oid=next(poid)
    purchase_orders.append((oid,order_no,req[0],sup[0],org,buyer,od,exp,"NULL",total,qty,disc,tax,pay,"CNY",random.choice([1,2,3,4]),random.choice([30,45,60,90]),wh,"",rs,ps,is_0,stat,now(),now(),0,0,"NULL",1,f"采购订单{i}"))
    for _ in range(random.randint(1,3)):
        ...
        amt=q*up
        t=round(amt*0.13,4)
        purchase_order_items.append((next(poiid),oid,None,sku[0],sku[3],sku[4],q,0,0,up,amt,13.0,t,0.0,rd(5,30),1,now(),now(),0,0,"NULL",1,None))
...
for po in purchase_orders:
    if po[26] < 2 and random.random()>0.3: continue
    ...
    iid=next(pisid)
    purchase_in_stocks.append((iid,in_no,po[0],sup,wh,op,ind,tq,ta,st,now(),now(),0,0,"NULL",1,None))
    for _ in range(random.randint(1,3)):
        sku=random.choice(skus)
        ...
        purchase_in_stock_items.append((next(pisiid),iid,None,sku[0],sku[3],sku[4],eq,aq,uq,bq,up,aq*up,loc,bn,rd(-200,-100),rd(100,300),2,now(),now(),0,0,"NULL",1,None))
...
for i in range(1,6):
    ...
    rid=next(prrid)
    purchase_returns.append((rid,ret_no,po[0],None,po[3],wh,op,ret_dt,reason,tq,ta,rs,st,now(),now(),0,0,"NULL",1,None))
    for _ in range(random.randint(1,2)):
        sku=random.choice(skus)
        q=random.randint(5,25)
        up=sku[8]
        purchase_return_items.append((next(prriid),rid,None,None,sku[0],sku[3],sku[4],q,up,q*up,reason,None,1,now(),now(),0,0,"NULL",1,None))
...
for i in range(1,6):
    ...
    rdd=rd(-80,0) if random.random()>0.5 else "NULL"
    ...
    tid=next(stid)
    stock_transfers.append((tid,f"DB2024{i:04d}",fw,tw,random.choice([1,2,3,4]),ap,ad,sd,rdd,None,None,tq,ta,ss,rs,st,now(),now(),0,0,"NULL",1,None))
    for _ in range(random.randint(1,3)):
        sku=random.choice(skus)
        q=random.randint(10,100)
        uc=sku[8]
        stock_transfer_items.append((next(stiid),tid,sku[0],sku[3],None,None,None,q,0,0,uc,q*uc,1,now(),now(),0,0,"NULL",1,None))
R["stock_transfer"]=stock_transfers
R["stock_transfer_item"]=stock_transfer_items
print("Inventory and transfers done")
...
for i in range(1,21):
    ...
    oid=next(soid)
    sales_orders.append((oid,order_no,cust[0],rep,org,wh,od,exp,del_dt,total,qty,disc,tax,pay,paid,"CNY",dt,"",cust[4],cust[5],ds,ps,is_0,st,now(),now(),0,0,"NULL",1,f"销售订单{i}"))
    for _ in range(random.randint(1,4)):
        ...
        amt=q*up
        t=round(amt*0.13,4)
        sales_order_items.append((next(soiid),oid,sku[0],sku[3],sku[4],q,0,0,up,amt,13.0,t,0.0,wh,1,now(),now(),0,0,"NULL",1,None))
...
for so in sales_orders:
    if so[26] < 3 and random.random()>0.3: continue
...
for i in range(1,6):
    ...
    rid=next(srid)
    sales_returns.append((rid,ret_no,so[0],None,so[2],wh,op,ret_dt,reason,tq,ta,rs,st,now(),now(),0,0,"NULL",1,None))
    for _ in range(random.randint(1,2)):
        sku=random.choice(skus)
        q=random.randint(2,15)
        up=sku[9]
        sales_return_items.append((next(sriid),rid,None,sku[0],sku[3],sku[4],q,up,q*up,13.0,round(q*up*0.13,4),reason,None,wh,None,1,now(),now(),0,0,"NULL",1,None))
...
for i in range(1,11):
    ...
    src=random.choice(purchase_orders)
    src_no=src[1]
    wh=random.choice(warehouses)[0]
    ...
    iid=next(wiid)
    wms_inbounds.append((iid,in_no,it,src_type,src[0],src_no,wh,sup,tsc,tq,ta,ad,ad,op,qcs,st_wms,now(),now(),0,0,"NULL",1,None))
    for _ in range(random.randint(1,4)):
        sku=random.choice(skus)
        ...
        loc=random.choice(locations)[0]
        bn=f"BN{random.randint(2024001,2024999)}"
        wms_inbound_items.append((next(wiiid),iid,sku[0],sku[3],eq,aq,uq,bq,up,aq*up,loc,bn,rd(-200,-50),rd(50,300),1,now(),now(),0,0,"NULL",1,None))
...
for i in range(1,11):
    ...
    src_type=random.choice([1,2,3])
    src=random.choice(sales_orders)
    src_no=src[1]
    wh=random.choice(warehouses)[0]
    ...
    oid=next(woid)
    wms_outbounds.append((oid,out_no,ot,src_type,src[0],src_no,wh,cust,tsc,tq,ta,pr,None,ps,pks,ss,st_wms,now(),now(),0,0,"NULL",1,None))
    for _ in range(random.randint(1,4)):
        sku=random.choice(skus)
        ...
        loc=random.choice(locations)[0]
        bn=f"BN{random.randint(2024001,2024999)}"
        wms_outbound_items.append((next(woiid),oid,sku[0],sku[3],eq,aq,up,aq*up,loc,bn,1,now(),now(),0,0,"NULL",1,None))
...
ftid=idg(1)
R["freight_template"]=[
    (next(ftid),"顺丰标准快递",1,1,1.0,12.0,1.0,8.0,99.0,'{"regions":[{"province":"新疆","first_price":20,"continue_price":15}]}',1,now(),now(),0,0,"NULL",1,None),
    (next(ftid),"中通经济快递",2,1,1.0,8.0,1.0,4.0,79.0,None,1,now(),now(),0,0,"NULL",1,None),
    (next(ftid),"京东特快",3,1,1.0,15.0,1.0,10.0,0.0,None,1,now(),now(),0,0,"NULL",1,None),
    (next(ftid),"德邦大件",4,2,10.0,30.0,10.0,15.0,199.0,'{"regions":[{"province":"西藏","first_price":50}]}',1,now(),now(),0,0,"NULL",1,None),
    (next(ftid),"跨越次日达",5,1,1.0,25.0,1.0,15.0,0.0,None,1,now(),now(),0,0,"NULL",1,None),
]
print("TMS done")
...
for i in range(1,8):
    ...
    sid2=next(sid)
    settlements.append((sid2,f"JS2024{i:04d}",st,party[0],pt,sdd,edd,ta,da,aa,"CNY",ss,1,now(),now(),0,0,"NULL",1,None))
    for _ in range(random.randint(1,3)):
        src=random.choice(account_payables if st==1 else account_receivables)
        sa=random.uniform(5000,50000)
        settlement_items.append((next(siid),sid2,1 if st==1 else 2,src[0],src[1],src[6],sa,0.0,1,now(),now(),0,0,"NULL",1,None))
...
for i in range(1,8):
    ...
    qid=next(qcid)
    quality_checks.append((qid,cn,ct,src_type,src[0],src_no,wh,sup,checker,cd,tsc,tq,qq,uq,cr,st2,now(),now(),0,0,"NULL",1,None))
    for _ in range(random.randint(1,3)):
        sku=random.choice(skus)
        ...
        qcitems.append((next(qcid),qid,sku[0],sku[3],None,cq,qq2,uq2,dt,dd,disp,cr2,1,now(),now(),0,0,"NULL",1,None))
...
for i in range(1,21):
    ...
    biz=random.choice(R["purchase_request"] if bt=="purchase_request" else (R["supplier_contract"] if bt=="supplier_contract" else (R["purchase_return"] if bt=="purchase_return" else (R["sales_return"] if bt=="sales_return" else R["purchase_order"]))))
...
for i in range(1,31):
    ...
    biz=random.choice(R["purchase_request"] if bt=="purchase_request" else (R["purchase_order"] if bt=="purchase_order" else (R["sales_order"] if bt=="sales_order" else (R["inventory"] if bt=="inventory" else R["supplier"]))))
...
# ===== 17. Alert Rules & Notifications =====
ruleid=idg(1)
alert_rules=[
    (next(ruleid),"RULE001","库存安全预警",1,"inventory",'{"field":"available_qty","op":"lt","value":"safety_stock"}','["email","system"]',"[1,2,3]","[2,6]",0,0,None,1,now(),now(),0,0,"NULL",1,"库存低于安全库存时触发"),
    (next(ruleid),"RULE002","合同到期预警",2,"supplier_contract",'{"field":"end_date","op":"lte","value":"advance_30d"}','["email","sms"]',"[1,2]","[2]",30,1,1440,1,now(),now(),0,0,"NULL",1,"合同到期前30天预警"),
    (next(ruleid),"RULE003","订单超期预警",3,"purchase_order",'{"field":"expect_date","op":"lt","value":"today"}','["system"]',"[5,8]","[3]",0,1,60,1,now(),now(),0,0,"NULL",1,"采购订单超期未到货预警"),
    (next(ruleid),"RULE004","付款到期预警",4,"account_payable",'{"field":"due_date","op":"lte","value":"advance_7d"}','["email","system"]',"[10,15]","[7]",7,1,1440,1,now(),now(),0,0,"NULL",1,"应付单到期前7天预警"),
    (next(ruleid),"RULE005","质检异常预警",5,"quality_check",'{"field":"check_result","op":"eq","value":"2"}','["email","sms","system"]',"[1,8]","[2,8]",0,0,None,1,now(),now(),0,0,"NULL",1,"质检部分合格或不合格时触发"),
]
...
column_map={
    ...
    "inventory_batch": ["id","inventory_id","sku_id","warehouse_id","location_id","batch_no","production_date","expiry_date","available_qty","frozen_qty","total_qty","cost_price","total_cost","status","created_at","updated_at","created_by","updated_by","deleted_at","version","remark"],
    "stock_take": ["id","take_no","warehouse_id","take_type","take_method","plan_date","actual_date","operator_id","checker_id","total_sku_count","diff_sku_count","profit_amount","loss_amount","status","created_at","updated_at","created_by","updated_by","deleted_at","version","remark"],
    "stock_take_item": ["id","take_id","sku_id","location_id","batch_no","book_qty","actual_qty","diff_qty","unit_cost","diff_amount","reason","status","created_at","updated_at","created_by","updated_by","deleted_at","version","remark"],
